...
/*
    Zac Carpenter
    4/09/2021
    Purpose: This exercise practices using Optionals
 */
let userInputAge: String = "34"
//let userAge: Int = Int(userInputAge)
// error stating that userAge could not be unwrapped
/*:
...
let userAge: Int? = Int(userInputAge)
print(userAge)
// userAge is nil because there is not a integer value stored in userInputAge, it is a string
