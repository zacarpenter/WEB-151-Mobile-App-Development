...
/*
    Zac Carpenter
    04/14/2021
    Purpose: to gain a better understanding of local and global scope
 */
for _ in 0..<10 {
    let foo = 55
...
//print("The value of foo is \(foo)")
print("Because 'foo' is declared in the local scope of the for loop. It doesn't exist out side of that loop.")
...
// the variable x is first declared in the global scope and is modified in the local scope of the for loop
// foo is declared in the local scope and it is trying to be accessed outside of that scope in the second print statement
...
greeting(greeting: nil, name: "Zac")
/*:
